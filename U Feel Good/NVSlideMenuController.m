...
- (id)initWithMenuViewController:(UIViewController *)menuViewController andContentViewController:(UIViewController *)contentViewController
{
	...
	if (self)
	{
		...
		self.panGestureEnabled = NO; // for stop finger slider
...
//        else
//        {
		self.menuWidth = (self.view.frame.size.width/4) *3;
       // }
...
{
	return	[self.menuViewController shouldAutorotate] &&[self.contentViewController shouldAutorotate];//&& self.panGesture.state != UIGestureRecognizerStateChanged;
}
